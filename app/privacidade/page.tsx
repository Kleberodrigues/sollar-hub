    ...
    <div className="min-h-screen bg-bg-tertiary">
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <SlideUp className="mb-12 text-center">
          <h1 className="font-display text-4xl md:text-5xl font-bold text-sollar-green-dark mb-4">
        ...
        <StaggerContainer staggerDelay={0.15} delayChildren={0.2}>
          <article className="space-y-12 font-serif text-text-primary">
            ...
            >
              <h2 className="font-display text-2xl font-semibold text-sollar-green-dark mb-4">
            ...
            >
              ...
              <p className="text-base leading-relaxed">
                ...
                <a
                  ...
                  className="text-sollar-terracotta hover:text-sollar-terracotta-hover underline transition-colors"
                >
