...
// Simplified posts content without nested template literals
const postsContent = `// Blog Posts Data - Artigos sobre NR-1, Riscos Psicossociais e Saúde Mental no Trabalho
...
fs.writeFileSync('lib/blog/posts.ts', postsContent, 'utf8');
console.log('Posts file created successfully');
