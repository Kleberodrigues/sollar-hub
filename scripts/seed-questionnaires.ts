...
// Questionário Pulse - 5 perguntas rápidas
const pulseQuestions: Question[] = [
  {
    text: 'Como você está se sentindo hoje em relação ao trabalho?',
    type: 'multiple_choice',
    category: 'anchors',
    order_number: 1,
    required: true,
    options: ['😊 Muito bem', '🙂 Bem', '😐 Neutro', '😕 Não muito bem', '😔 Mal'],
    is_strategic_open: false,
  },
  {
    text: 'De 0 a 10, qual sua satisfação geral com o trabalho neste momento?',
    type: 'likert_scale',
    category: 'anchors',
    order_number: 2,
    required: true,
  ...
  {
    text: 'Sua carga de trabalho está sustentável?',
    type: 'likert_scale',
    category: 'demands_and_pace',
    order_number: 3,
    required: true,
    scale_labels: { '1': 'Muito baixa', '2': 'Baixa', '3': 'Adequada', '4': 'Alta', '5': 'Muito alta' },
    risk_inverted: false,
    is_strategic_open: false,
  },
  {
    text: 'Como está a comunicação com sua liderança?',
    type: 'likert_scale',
    category: 'leadership_recognition',
    order_number: 4,
    required: true,
    scale_labels: { '1': 'Muito ruim', '2': 'Ruim', '3': 'Regular', '4': 'Boa', '5': 'Muito boa' },
    risk_inverted: false,
    is_strategic_open: false,
  },
  {
    text: 'O ambiente de trabalho tem sido respeitoso e acolhedor?',
    type: 'likert_scale',
    category: 'relationships_communication',
    order_number: 5,
    required: true,
