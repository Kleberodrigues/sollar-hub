...
const socialLinks = [
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/psicomapa",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/psicomapa",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: "Twitter",
    href: "https://twitter.com/psicomapa",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/psicomapa",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-white/70 mb-4 max-w-xs">
              Plataforma completa para diagnóstico e gestão de riscos
              psicossociais no ambiente de trabalho.
            </p>
            <p className="text-sm text-pm-olive-light font-medium">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/60 text-sm">
            &copy; {new Date().getFullYear()} PsicoMapa. Todos os direitos
            reservados.
          </p>
