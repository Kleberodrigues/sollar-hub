...
const plans = [
  {
    ...
    objective: '20 relatórios anuais',
    icon: Building,
    color: 'terracotta' as const,
    yearlyPrice: 'R$ 3.970',
    monthlyEquivalent: 'Equivalente a R$ 330,83/mês',
    features: [
      '12 Relatórios de Clima',
      '4 Relatórios Técnicos de Riscos Psicossociais',
      '4 Relatórios de Plano de Ação',
      'Dashboards automáticos',
      'Análise de dados completa',
      'Ferramenta de Plano de Ação orientado à prevenção',
    ],
    highlighted: false,
  },
  {
    ...
    objective: '30 relatórios anuais',
    icon: Building2,
    ...
    features: [
      'Tudo do plano Base',
      '+ 6 Relatórios Executivos para liderança',
      '+ 4 Relatórios de Correlação entre fatores organizacionais',
    ],
    highlighted: true,
  },
  {
